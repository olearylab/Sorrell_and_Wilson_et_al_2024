function [h_boots] = plot_many_svm_bvn_classifier_results_25072023(accuracies_cell_bvn,accuracies_cell_shuff,centres)
% 25/07/2023

% Function for plotting results of svm classification of trials as ball vs 
% bmi using behaviour (forward and angular velocity)
...
titles = ["Ball vs BMI classifier";"using ball velocities"];
figure
...
% boostrap stds as shaded regions
boot_stds = all_sems;
...
title(["Ball vs BMI classifier";"using ball velocities"])
ylim([0,1])
