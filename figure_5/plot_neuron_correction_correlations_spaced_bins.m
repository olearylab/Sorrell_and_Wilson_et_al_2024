function [h_boot,ex_md,ro,ro_p,n_kept] = plot_neuron_correction_correlations_spaced_bins(z_binned_cell,error_cell,tbt_cell,x_binned_cell,error_thresh,bin_space,num_shuff,shuff_limit)
% 26/10/2023

% Function for plotting correlation of population neural activity with error
...
% Include circular shuffles for H-boot sig test. Also any shuffles
...
ylabel(["Mean BMI trial normalized"; "population activity"])
yline(0,'--','LineWidth',2);
