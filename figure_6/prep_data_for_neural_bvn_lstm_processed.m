function [ss,centres] = prep_data_for_neural_bvn_lstm_processed(zdatafilt,virmen_data,tbt_details,nbins,keep_incorrect,kept_types,balance_types)
% 02/08/2023

% Prepare data for input into svm function.
% Neural data already preprocessed
...
% Store relevant variables for only kept trial types.
...
% Set ball trials as 1, bmi trials as 2
